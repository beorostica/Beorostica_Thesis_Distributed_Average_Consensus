This folder contains the necessary files to simulate the Push-Sum protocol 
with an Hybrid simulator HyEQ made by Sanfelice (https://hybrid.soe.ucsc.edu/software).

Just run the "run.m" file. The output will be "DataPushSum_top_1_freq_1.mat" files and the 
file "DataBroadcastGossipGeneral.mat" which contain the results of the simulations:
-DataPushSum_top_1_freq_1
-DataPushSum_top_1_freq_2
-DataPushSum_top_1_freq_3
-DataPushSum_top_1_freq_4
-DataPushSum_top_2_freq_1
-DataPushSum_top_2_freq_2
-DataPushSum_top_2_freq_3
-DataPushSum_top_2_freq_4
-DataPushSumGeneral.mat

The "run.m" calls the simulink file "Hybrid_Model_PushSum.slx". Every time there is a realization
...
the file "DataPushSum_top_2_freq_3.mat", change this:
...
